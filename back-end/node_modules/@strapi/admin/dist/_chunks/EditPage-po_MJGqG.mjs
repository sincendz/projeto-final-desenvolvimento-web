...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-eT0CIaDr.mjs";
...
import { u as useWebhooks } from "./useWebhooks-FgW5WF9_.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-DiHkzjty.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-po_MJGqG.mjs.map

...
const useWebhooks = require("./useWebhooks-yfZ95LU8.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-v1WZ_gi9.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-b1mM_YNY.js.map

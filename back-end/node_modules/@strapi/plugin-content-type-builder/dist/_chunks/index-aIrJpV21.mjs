...
const ListView$1 = lazy(() => import("./ListView-KOGSQUwn.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-KOGSQUwn.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-aIrJpV21.mjs.map
